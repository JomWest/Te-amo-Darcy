...
backgroundGradient.addColorStop(0, '#FF6163')
backgroundGradient.addColorStop(1, '#D05CF1')
...
function animate() {
    ...
    if(flag) creatMountainRange(1, canvas.height * 0.7, '#D4BFBF')
    if(flag) creatMountainRange(2, canvas.height * 0.6, '#F0CFCF')
    if(flag) creatMountainRange(3, canvas.height * 0.4, '#CAB9B9')
    c.fillStyle = '#CE81E3'
    ...
    if(ticker % randomSpawnRate == 0){
        ...
        stars.push(new Star(x, -100, 9, '#88B5E5'))
